...
| 課題期間にやらなかったこと | 新機能の拡張、単一ファイル（<!-- MAIN_FILE_LINES -->17423<!-- /MAIN_FILE_LINES --> 行）の分割（理由は「4. 判断・制約・学び」） |
...
期待: 全件緑（<!-- TOTAL_TESTS -->3023<!-- /TOTAL_TESTS --> 本のうち、実機が要る 28 本を除いた範囲）。
...
3. 未知の依頼文に対する翻訳精度の測定（今は凍結検体上の数字しかありません）
