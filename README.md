...
| 課題期間に**やらなかったこと** | 新機能の拡張、単一ファイル（<!-- MAIN_FILE_LINES -->16205<!-- /MAIN_FILE_LINES --> 行）の分割（理由は「4. 判断・制約・学び」） |
...
期待: 全件緑（<!-- TOTAL_TESTS -->2787<!-- /TOTAL_TESTS --> 本のうち、実機が要る 28 本を除いた範囲）。
...
（表 3 種 × 基本操作 6 種 × 言い回しの揺れ = 84 件・op 名でなく
**出来上がったファイル**で判定）で、**86.9% → 94.0% → 97.6%**（82/84・断り 1・失敗 1）に上がりました。
