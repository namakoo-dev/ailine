...
# ★★ 2026-09-22: 画面に出る「事後条件」の言い方を **ここ 1 箇所に集める**。
#   実測で **14 箇所**に書き写されていた（`⚠ 事後条件が破れた: ` だけで 9 箇所）。
#   盲検の買い手役が 3・4・5 体目と**続けて**「意味が分からない語」に挙げている
#   （DESIGN-20260915 ⑧ / -20260918 ⑦ / -20260920）── つまり**言い換える日が来る**。
#   その日に「片方だけ直った」を作らないために、言い換えより先に畳む。
#   ★ この冊の上の方に書いてある理由そのもの: 同じ事情を別の文で言うと、
#     **同じ穴なのに別の穴に見える**。
#
# ★★ 言い換えの向きの制約（消さないこと）:
