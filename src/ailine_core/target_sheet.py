...
_OP_VERBS = {
    ...
    "ADD_ROW": ("行を追加する", "行を追加した"),
    "DELETE_ROWS": ("行を削除する", "行を削除した"),
    "DEDUP_DELETE": ("重複行を削除する", "重複行を削除した"),
    "DELETE_COLUMN": ("列を削除する", "列を削除した"),
    "MOVE_COLUMN": ("列を動かす", "列を動かした"),
    "SET_CELL_VALUE": ("1 セルを書き換える", "1 セルを書き換えた"),
    "SWAP": ("入れ替える", "入れ替えた"),
    "ADD_COLUMN": ("列を追加する", "列を追加した"),
    "SET_WHERE": ("条件つきで書き換える", "条件つきで書き換えた"),
    "EXTRACT_COLUMNS": ("列を抜き出す", "列を抜き出した"),
